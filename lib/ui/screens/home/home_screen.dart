...
class _HomeScreenState extends State<HomeScreen> with WidgetsBindingObserver {
  ...
  String _getFirstName(String fullName) {   //taha
    ...
    return BlocConsumer<QuizoneCategoryCubit, QuizoneCategoryState>(
      ...
      builder: (context, state) {
        ...
        if (state is QuizoneCategorySuccess) {
          ...
          const minCount = 3; /// taha min max
          const maxCount = 7;  /// 5 def
  ...
  final List<int> randomNumbers = [ 37];
          ...
          BlocConsumer<ContestCubit, ContestState>(
            ...
            builder: (context, state) {
              ...
              if (state is ContestSuccess) {
                ...
                final randomNumber = randomNumbers[random.nextInt(randomNumbers.length)];
                final participantsCount = int.tryParse(contest.participants.toString()) ?? 0;
                final participantsWithRandom = participantsCount + randomNumber;
                                ...
                                Text.rich(
                                  ...
                                  TextSpan(
                                    children: [
                                      ...
                                      TextSpan(
                                        text: participantsWithRandom.toString(),
