                            ...
                            children: [
                              Container(
                                ...
                                child: Image.asset(
                                  ...
                                  width: 25,
                                  height: 25,
                                  // color: Theme.of(context).primaryColor, // Optional: for monochrome PNGs
                                ),
                                ...
                                children: [
                                  Padding(
                                    padding: const EdgeInsetsDirectional.only(
                                      start: 7,
                                      top: 2,
                                      bottom: 2,   /// left here run app before
                                    ),
                                    // child: SvgPicture.asset(
                                    //   menu[index].image,
                                    //   colorFilter: ColorFilter.mode(
                                    ...
                                    // ),
                                    child: Image.asset(
                                      menu[index].image, /// taha
                                      width: 25,
                                      height: 25,
                                      // color: Theme.of(context).primaryColor, // optional, for color tinting monochrome PNGs
                                    ),
