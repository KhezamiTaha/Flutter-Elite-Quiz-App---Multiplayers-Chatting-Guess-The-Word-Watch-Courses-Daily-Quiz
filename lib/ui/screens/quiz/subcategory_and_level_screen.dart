...
class _AnimatedSubcategoryContainerState
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      padding: const EdgeInsets.all(7),  /// 10 is defoult
        ...
        children: [
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.start, /// added by taha
                children: [
                  /// subcategory Icon
                  Container(
                    height: 55, /// 45 is default
                    width: 55,
                    decoration: BoxDecoration(
                  ...
                  const SizedBox(width: 12), /// taha 10
