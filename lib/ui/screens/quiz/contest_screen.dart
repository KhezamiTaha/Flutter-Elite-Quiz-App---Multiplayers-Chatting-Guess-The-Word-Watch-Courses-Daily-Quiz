...
class _ContestCard extends StatefulWidget {
  const _ContestCard({required this.contestDetails, required this.contestType, required this.index,});
...
class _ContestCardState extends State<_ContestCard> {
  ...
  Widget build(BuildContext context) {
    ...
    // 🔽 Add the logic here:
    final baseParticipants = int.tryParse(widget.contestDetails.participants ?? '0') ?? 0;
    final displayParticipants = widget.index == 0 ? baseParticipants + 37 : baseParticipants + 5;
