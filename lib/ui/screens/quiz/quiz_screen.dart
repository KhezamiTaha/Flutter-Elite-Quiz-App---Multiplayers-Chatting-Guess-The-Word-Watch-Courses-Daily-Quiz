...
class _QuizScreenState extends State<QuizScreen> with TickerProviderStateMixin {
        ...
        child: SlideTransition(
          ...
          child: Padding(
            ...
            child: CustomRoundedButton(
              ...
              showBorder: true,
              borderColor: Colors.grey.shade400, // Modern soft grey
              radius: 8,
              height: 40,
              elevation: 5, // Modern flat look  /// 5 is default
  ...
  Widget _buildLifelineContainer({
    ...
    final isUnused = lifelines[title] == LifelineStatus.unused;
