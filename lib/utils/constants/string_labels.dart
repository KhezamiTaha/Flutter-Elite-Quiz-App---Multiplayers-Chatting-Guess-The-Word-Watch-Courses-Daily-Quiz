...
//IntroSliderScreen
const description1 = 'Explore fun quizzes that help you master vocabulary, grammar, and pronunciation — all while playing.';
const description2 = 'Track your progress, unlock achievements, and stay sharp with daily questions tailored to your level.';
const description3 = 'Compete with others, share your scores, and grow together in a global community of learners.';
const title1 = 'Learn Through Play';
const title2 = 'Challenge Yourself Daily';
const title3 = 'Join the Language Learner Community';
